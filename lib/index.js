...
console.log("\x1b[33m", "WebuxJS - Attach Custom express responses", "\x1b[0m");
...
async function InitLocalStrategy(loginFn, registerFn) {
  console.log("\x1b[33m", "WebuxJS - Initialize Local Strategy", "\x1b[0m");
...
async function InitJWTStrategy(deserializeFn = null) {
  console.log("\x1b[33m", "WebuxJS - Initialize JWT Strategy", "\x1b[0m");
  await initJWTStrategy(this.config.auth, this.Auth.passport, deserializeFn);
}

async function InitRedis() {
  console.log("\x1b[33m", "WebuxJS - Initialize Redis", "\x1b[0m");
  await initializeRedis(this.config.auth.redis);
}

function CreateIsAuth(option) {
  console.log("\x1b[33m", "WebuxJS - Create isAuth Functions", "\x1b[0m");
